/**
 * VitalsTrendCard — recent vital-sign trends (CU-067).
 *
 * Renders the precomputed vitals trend series (HRV, resting HR, SpO₂, …) through
 * the design-system LineChart. Series arrive chart-ready from the contract — no
...
import { trendHasData } from '../vitalsModel';
...
export function VitalsTrendCard({
  ...
  reducedMotion = false,
  testID,
}: VitalsTrendCardProps): React.JSX.Element | null {
