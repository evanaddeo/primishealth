/**
 * RecoveryBanner — calm, non-blocking provisional/stale notice (CU-065).
 *
 * Surfaces a provisional ("early read") or stale ("waiting on sync") state
 * without alarm (UX-REC-003). Status is conveyed by both a dot color AND text,
...
export interface RecoveryBannerProps {
  banner: RecoveryBannerVm;
  testID?: string;
}

export function RecoveryBanner({ banner, testID }: RecoveryBannerProps): React.JSX.Element {
